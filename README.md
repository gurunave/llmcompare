...
speed and context, for 161 models across 32 providers — 101 of them open-weights,
...
| `/models/[id]` | One page per model — headline stats, its own radar and benchmark bars, full specs, and the closest alternatives by price and capability. 161 statically generated pages. |
