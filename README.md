...
speed and context, for 102 models across 26 providers — 67 of them open-weights,
...
| `/models/[id]` | One page per model — headline stats, its own radar and benchmark bars, full specs, and the closest alternatives by price and capability. 102 statically generated pages. |
